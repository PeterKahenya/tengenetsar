var fundi_peer_id =document.getElementById('fundi_id').value;
...
function setup_call(peer_object){
  ...
  if (!supports["facingMode"]) {
    alert("FACING MODE NOT SUPPORTED")
  }
  getUserMedia({video: {facingMode:{exact:"environment"}}, audio: true}, function(stream) {
...
start_call_button.onclick=(e)=> {
  ...
  peer.on('open',function (peer_id){
    ...
    var connection=peer.connect(fundi_peer_id,{
      reliable:true
    })
